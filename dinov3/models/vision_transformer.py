...
from dinov3.layers import LayerScale, Mlp, PatchEmbed, RMSNorm, RopePositionEmbedding, RopePositionEmbedding3D, SelfAttentionBlock, SwiGLUFFN
...
def meddinov3_base(patch_size=16, **kwargs):
    model = MedDINOv3(
        patch_size=patch_size,
        embed_dim=864,
        depth=16,
...
def meddinov3_large(patch_size=16, **kwargs):
    model = MedDINOv3(
        patch_size=patch_size,
        embed_dim=1152,
        depth=24,
...
class FlexiMedDINOv3_VLM(nn.Module):
    def __init__(
        self,
        *,
...
def fleximeddinov3_small(patch_size=16, **kwargs):
    model = FlexiMedDINOv3(
        patch_size=patch_size,
        embed_dim=432,
        depth=12,
        num_heads=6,
...
def fleximeddinov3_base(patch_size=16, **kwargs):
    model = FlexiMedDINOv3(
        patch_size=patch_size,
        embed_dim=864,
        depth=16,
...
def fleximeddinov3_large(patch_size=16, **kwargs):
    model = FlexiMedDINOv3(
        patch_size=patch_size,
        embed_dim=1152,
        depth=24,
